...
/*   Updated: 2020/12/02 18:15:15 by abdait-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     main(int argc, char **argv)
{
	...
	close(fd2);
    printf("================== STRLEN FUNC ================ \n");
    printf("ft_strlen.s ==> |%lu|\n", ft_strlen("kjadhsfkdjshfkdjsfhksdhfksdhfkdsfhkshfksufhksuhfku"));
    printf("strlen ==> |%lu|\n", strlen("kjadhsfkdjshfkdjsfhksdhfksdhfkdsfhkshfksufhksuhfku"));
}